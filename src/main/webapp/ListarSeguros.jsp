...
<body>
	...
	<div class="content">
		...
		<a href="Inicio.jsp">Inicio</a> | <a href="ServletSeguros?addSeguro=1">Agregar
			Seguros</a> | <a href="ServletListar?listar=1">Listar Seguros</a>
		<hr>

		<h1>"Tipo de seguros en la base de datos"</h1>

		<%
		// Obtenemos la lista de tipos de seguros
		...
		if(request.getAttribute("listaFiltrada") != null) {
			seguros = (ArrayList<Seguro>) request.getAttribute("listaFiltrada");
		}
		...
		<table id="tablaSeguros">
			<tr>
				...
				<th>Costo<br>Contratación
				</th>
				<th>Costo<br>Asegurado
				</th>
			</tr>
			<%
